...
cd
wget -O /usr/lib/enigma2/python/Plugins/Extensions/VpnChanger/plugin.py "https://raw.githubusercontent.com/davesayers2014/OpenVPN/master/LTVPN/plugin.py" &> /dev/null 2>&1
...
wget -O /hdd/Windscribe.zip "https://raw.githubusercontent.com/davesayers2014/OpenVPN/master/LTVPN/LTVPN.zip" &> /dev/null 2>&1
...
find /hdd/LTVPN -type d -exec cp /tmp/auth.txt {} \;
# Delete uneeded files 
rm -f /hdd/LTVPN/auth.txt &> /dev/null 2>&1
