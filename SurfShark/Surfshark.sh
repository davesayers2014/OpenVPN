...
cd
wget -O /usr/lib/enigma2/python/Plugins/Extensions/VpnChanger/plugin.py "https://raw.githubusercontent.com/davesayers2014/OpenVPN/master/SurfShark/plugin.py" &> /dev/null 2>&1
...
find /hdd/surfsharkvpn -type d -exec cp /tmp/auth.txt {} \;
# Delete uneeded files 
rm -f /hdd/surfsharkvpn/auth.txt &> /dev/null 2>&1
