...
#cd /var && cd /var/volatile && cd /var/volatile/tmp && wget -O /var/volatile/tmp/openvpn_2.4.3-r0.1_cortexa15hf-neon-vfpv4.ipk "https://github.com/davesayers2014/OpenVPN/blob/PY3/openvpn_2.4.3-r0.1_cortexa15hf-neon-vfpv4.ipk?raw=true" &> /dev/null 2>&1
echo "downloading IP Checker"
echo $LINE
cd /var && cd /var/volatile && cd /var/volatile/tmp && wget -O /var/volatile/tmp/enigma2-plugin-extensions-ipchecker_001_all.ipk "https://github.com/davesayers2014/OpenVPN/blob/PY3/enigma2-plugin-extensions-ipchecker_001_all.ipk?raw=true" &> /dev/null 2>&1
...
wget -O /etc/openvpn/user.txt "https://raw.githubusercontent.com/davesayers2014/OpenVPN/PY3/login.conf" &> /dev/null 2>&1
