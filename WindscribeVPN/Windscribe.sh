...
echo $LINE
mkdir -p /etc/hdd/Windscribe
wget -O /hdd/Windscribe/Windscribe.zip "https://raw.githubusercontent.com/davesayers2014/OpenVPN/PY3/WindscribeVPN/Windscribe.zip" &> /dev/null 2>&1
...
sed -i '$i config.vpnmanager.directory=/hdd/Windscribe/' /etc/enigma2/settings
